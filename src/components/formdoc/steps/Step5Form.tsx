...
const IntellectualProductionForm: React.FC<IntellectualProductionFormProps> = ({
  index,
  onDelete,
  isDisabled,
}) => {
  return (
    <div className="intellectual-production-form">
      ...
      <p>
        Llene el formulario con los artículos realizados más relevantes para el
        cargo.
        <br />
      ...
      <input
        ...
        id="editorial"
        type="text"
        placeholder="Enlace o Editorial de Publicación"
        required
        disabled={isDisabled}
      />
      <select

export const infoDocentes = [
  {
    ...
    estudiossuperiores: [
      ...
      {
        tipoEstudio: "Postgrado",
        nombre:
          "Maestria en MAESTRIA EN DERECHO CONSTITUCIONAL Y PROCESAL CONSTITUCIONAL",
      ...
      },
      {
        tipoEstudio: "Postgrado",
        nombre:
          "Maestría Mgr. en MAESTRIA EN INVESTIGACION CUALITATIVA APLICADA A LAS CIENCIAS SOCIALES",
  ...
  },
  {
    ...
    postgrado: [
      {
        nombre:
          "Diplomado en DIPLOMADO EN EDUCACION SUPERIOR BASADO EN COMPETENCIAS",
        universidad: "UCATEC",
        pais: "Bolivia",
        anio: "2024",
        modalidad: "Tesis",
  ...
  },
  {
    ...
    postgrado: [
      ...
      {
        nombre:
          "Especialidad Clínico Quirúrgico en SUBESPECIALIDAD ENDOCRINOLOGIA PEDIATRICA",
